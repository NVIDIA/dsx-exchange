...
```text
BMS/v1/PUB/Metadata/BESS/{pointType}/{tagPath}
```
...
|-----------|-------------|
| `pointType` | BESS point type. Values: `Status`, `Available`, `GenericPoint` |
| `tagPath` | Vendor-defined hierarchical tag path. |

## Message: BESS Status Metadata
...
## Message: BESS Available Metadata
