...
Subscribe to real-time BMS-published values for Damper points.
...
```text
BMS/v1/PUB/Value/Damper/{pointType}/{tagPath}
```
...
|-----------|-------------|
| `pointType` | BMS-published Damper point type. Values: `DamperPosition`, `Available`, `GenericPoint` |
