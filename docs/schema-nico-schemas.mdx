...
|------|------|----------|-------------|
| `dpu_states` | [DpuDiscoveringStates](schema-nico-schemas#dpudiscoveringstates) | Yes |  |
| `dpu_states.states` | map\&lt;string, [DpuDiscoveringState](schema-nico-schemas#dpudiscoveringstate)\> | Yes |  |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `dpu_states` | [DpuInitStates](schema-nico-schemas#dpuinitstates) | Yes |  |
| `dpu_states.states` | map\&lt;string, [DpuInitState](schema-nico-schemas#dpuinitstate)\> | Yes |  |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `machine_state` | [MachineState](schema-nico-schemas#machinestate) | Yes |  |
...
| `validation_state` | [ValidationState](schema-nico-schemas#validationstate) | Yes |  |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `instance_state` | [InstanceState](schema-nico-schemas#instancestate) | Yes | Possible Instance state-machine implementation, for when the machine host is assigned to a tenant |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `cleanup_state` | [CleanupState](schema-nico-schemas#cleanupstate) | Yes |  |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `details` | [FailureDetails](schema-nico-schemas#failuredetails) | Yes |  |
| `details.cause` | [FailureCause](schema-nico-schemas#failurecause) | Yes |  |
| `details.failed_at` | string (date-time) | Yes |  |
| `details.source` | [FailureSource](schema-nico-schemas#failuresource) | Yes |  |
| `machine_id` | [MachineId](schema-nico-schemas#machineid) | Yes |  |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `dpu_states` | [DpuReprovisionStates](schema-nico-schemas#dpureprovisionstates) | Yes |  |
| `dpu_states.states` | map\&lt;string, [ReprovisionState](schema-nico-schemas#reprovisionstate)\> | Yes |  |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `reprovision_state` | [HostReprovisionState](schema-nico-schemas#hostreprovisionstate) | Yes |  |
| `retry_count` | integer (uint32) | No |  |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `measuring_state` | [MeasuringState](schema-nico-schemas#measuringstate) | Yes | MeasuringState contains states used for host attestion (or measured boot). |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `bom_validating_state` | [BomValidating](schema-nico-schemas#bomvalidating) | Yes |  |
...
| `firmware_type` | [FirmwareComponentType](schema-nico-schemas#firmwarecomponenttype) | Yes | Values: `bmc`, `cec`, `uefi`, `nic`, `cpldmb`, `cpldpdb`, `hgxbmc`, `combinedbmcuefi`, ... (10 total) |
| `task_id` | string | Yes |  |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `MatchingSku` | [BomValidatingContext](schema-nico-schemas#bomvalidatingcontext) | Yes | A context for passing information between states thoughout the BOM validation process. |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `UpdatingInventory` | [BomValidatingContext](schema-nico-schemas#bomvalidatingcontext) | Yes | A context for passing information between states thoughout the BOM validation process. |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `VerifyingSku` | [BomValidatingContext](schema-nico-schemas#bomvalidatingcontext) | Yes | A context for passing information between states thoughout the BOM validation process. |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `SkuVerificationFailed` | [BomValidatingContext](schema-nico-schemas#bomvalidatingcontext) | Yes | A context for passing information between states thoughout the BOM validation process. |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `WaitingForSkuAssignment` | [BomValidatingContext](schema-nico-schemas#bomvalidatingcontext) | Yes | A context for passing information between states thoughout the BOM validation process. |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `SkuMissing` | [BomValidatingContext](schema-nico-schemas#bomvalidatingcontext) | Yes | A context for passing information between states thoughout the BOM validation process. |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `secure_erase_boss_context` | [SecureEraseBossContext](schema-nico-schemas#secureerasebosscontext) | Yes |  |
| `secure_erase_boss_context.boss_controller_id` | string | Yes |  |
| `secure_erase_boss_context.iteration` | integer or null | No |  |
| `secure_erase_boss_context.secure_erase_boss_state` | [SecureEraseBossState](schema-nico-schemas#secureerasebossstate) | Yes |  |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `create_boss_volume_context` | [CreateBossVolumeContext](schema-nico-schemas#createbossvolumecontext) | Yes |  |
...
| `create_boss_volume_context.create_boss_volume_state` | [CreateBossVolumeState](schema-nico-schemas#createbossvolumestate) | Yes |  |
...
| `create_boss_volume_state` | [CreateBossVolumeState](schema-nico-schemas#createbossvolumestate) | Yes |  |
...
| `enable_secure_boot_state` | [SetSecureBootState](schema-nico-schemas#setsecurebootstate) | Yes |  |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `states` | map\&lt;string, [DpuDiscoveringState](schema-nico-schemas#dpudiscoveringstate)\> | Yes |  |
...
| `substate` | [InstallDpuOsState](schema-nico-schemas#installdpuosstate) | Yes |  |
...
| `substate` | [PerformPowerOperation](schema-nico-schemas#performpoweroperation) | Yes |  |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `states` | map\&lt;string, [DpuInitState](schema-nico-schemas#dpuinitstate)\> | Yes |  |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `states` | map\&lt;string, [ReprovisionState](schema-nico-schemas#reprovisionstate)\> | Yes |  |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `cause` | [FailureCause](schema-nico-schemas#failurecause) | Yes |  |
| `failed_at` | string (date-time) | Yes |  |
| `source` | [FailureSource](schema-nico-schemas#failuresource) | Yes |  |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `statemachinearea` | [StateMachineArea](schema-nico-schemas#statemachinearea) | Yes | Values: `default`, `hostinit`, `mainflow`, `assignedinstance` |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `set_boot_order_info` | [SetBootOrderInfo](schema-nico-schemas#setbootorderinfo) | Yes |  |
| `set_boot_order_info.set_boot_order_jid` | string or null | No |  |
| `set_boot_order_info.set_boot_order_state` | [SetBootOrderState](schema-nico-schemas#setbootorderstate) | Yes |  |
...
| `initialreset.phase` | [InitialResetPhase](schema-nico-schemas#initialresetphase) | Yes | Values: `start`, `bmcwasreset`, `waithostboot` |
...
| `waitingforupload.firmware_type` | [FirmwareComponentType](schema-nico-schemas#firmwarecomponenttype) | Yes | Values: `bmc`, `cec`, `uefi`, `nic`, `cpldmb`, `cpldpdb`, `hgxbmc`, `combinedbmcuefi`, ... (10 total) |
...
| `waitingforfirmwareupgrade.firmware_type` | [FirmwareComponentType](schema-nico-schemas#firmwarecomponenttype) | Yes | Values: `bmc`, `cec`, `uefi`, `nic`, `cpldmb`, `cpldpdb`, `hgxbmc`, `combinedbmcuefi`, ... (10 total) |
...
| `resetfornewfirmware.firmware_type` | [FirmwareComponentType](schema-nico-schemas#firmwarecomponenttype) | Yes | Values: `bmc`, `cec`, `uefi`, `nic`, `cpldmb`, `cpldpdb`, `hgxbmc`, `combinedbmcuefi`, ... (10 total) |
...
| `newfirmwarereportedwait.firmware_type` | [FirmwareComponentType](schema-nico-schemas#firmwarecomponenttype) | Yes | Values: `bmc`, `cec`, `uefi`, `nic`, `cpldmb`, `cpldpdb`, `hgxbmc`, `combinedbmcuefi`, ... (10 total) |
...
| `failedfirmwareupgrade.firmware_type` | [FirmwareComponentType](schema-nico-schemas#firmwarecomponenttype) | Yes | Values: `bmc`, `cec`, `uefi`, `nic`, `cpldmb`, `cpldpdb`, `hgxbmc`, `combinedbmcuefi`, ... (10 total) |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `platform_config_state` | [HostPlatformConfigurationState](schema-nico-schemas#hostplatformconfigurationstate) | Yes |  |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `network_config_update_state` | [NetworkConfigUpdateState](schema-nico-schemas#networkconfigupdatestate) | Yes | Tenant has requested network config update for the existing instance. At this point, instance config, instance network config version are already increased. Values: `waitingfornetworksegmenttoberea... |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `mode` | [LockdownMode](schema-nico-schemas#lockdownmode) | Yes | Whether lockdown should be enabled or disabled in an operation Values: `enable`, `disable` |
| `state` | [LockdownState](schema-nico-schemas#lockdownstate) | Yes | Values: `setlockdown`, `timewaitfordpudown`, `waitfordpuup`, `pollinglockdownstatus` |
...
| `uefi_setup_info` | [UefiSetupInfo](schema-nico-schemas#uefisetupinfo) | Yes |  |
| `uefi_setup_info.uefi_password_jid` | string or null | No |  |
| `uefi_setup_info.uefi_setup_state` | [UefiSetupState](schema-nico-schemas#uefisetupstate) | Yes | Substates of enabling/disabling lockdown |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `lockdown_info` | [LockdownInfo](schema-nico-schemas#lockdowninfo) | Yes |  |
| `lockdown_info.mode` | [LockdownMode](schema-nico-schemas#lockdownmode) | Yes | Whether lockdown should be enabled or disabled in an operation Values: `enable`, `disable` |
| `lockdown_info.state` | [LockdownState](schema-nico-schemas#lockdownstate) | Yes | Values: `setlockdown`, `timewaitfordpudown`, `waitfordpuup`, `pollinglockdownstatus` |
...
| `bmcfirmwareupgrade.substate` | [BmcFirmwareUpgradeSubstate](schema-nico-schemas#bmcfirmwareupgradesubstate) | Yes |  |
...
| `installdpuos.substate` | [InstallDpuOsState](schema-nico-schemas#installdpuosstate) | Yes |  |
...
| `boss_controller_id` | string | Yes |  |
| `iteration` | integer or null | No |  |
| `secure_erase_boss_state` | [SecureEraseBossState](schema-nico-schemas#secureerasebossstate) | Yes |  |
...
| `set_boot_order_state` | [SetBootOrderState](schema-nico-schemas#setbootorderstate) | Yes |  |
...
| `uefi_setup_state` | [UefiSetupState](schema-nico-schemas#uefisetupstate) | Yes | Substates of enabling/disabling lockdown |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `machine_validation` | [MachineValidatingState](schema-nico-schemas#machinevalidatingstate) | Yes |  |
