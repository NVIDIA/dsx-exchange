...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `machine_state` | [MachineState](schema-nico-schemas.mdx#machinestate) | Yes |  |
...
| `validation_state` | [ValidationState](schema-nico-schemas.mdx#validationstate) | Yes |  |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `instance_state` | [InstanceState](schema-nico-schemas.mdx#instancestate) | Yes | Possible Instance state-machine implementation, for when the machine host is assigned to a tenant |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `cleanup_state` | [CleanupState](schema-nico-schemas.mdx#cleanupstate) | Yes |  |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `details` | [FailureDetails](schema-nico-schemas.mdx#failuredetails) | Yes |  |
| `details.cause` | [FailureCause](schema-nico-schemas.mdx#failurecause) | Yes |  |
| `details.failed_at` | string (date-time) | Yes |  |
| `details.source` | [FailureSource](schema-nico-schemas.mdx#failuresource) | Yes |  |
| `machine_id` | [MachineId](schema-nico-schemas.mdx#machineid) | Yes |  |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `reprovision_state` | [HostReprovisionState](schema-nico-schemas.mdx#hostreprovisionstate) | Yes |  |
| `retry_count` | integer (uint32) | No |  |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `measuring_state` | [MeasuringState](schema-nico-schemas.mdx#measuringstate) | Yes | MeasuringState contains states used for host attestion (or measured boot). |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `bom_validating_state` | [BomValidating](schema-nico-schemas.mdx#bomvalidating) | Yes |  |
...
| `firmware_type` | [FirmwareComponentType](schema-nico-schemas.mdx#firmwarecomponenttype) | Yes | Values: `bmc`, `cec`, `uefi`, `nic`, `cpldmb`, `cpldpdb`, `hgxbmc`, `combinedbmcuefi`, ... (10 total) |
| `task_id` | string | Yes |  |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `MatchingSku` | [BomValidatingContext](schema-nico-schemas.mdx#bomvalidatingcontext) | Yes | A context for passing information between states thoughout the BOM validation process. |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `UpdatingInventory` | [BomValidatingContext](schema-nico-schemas.mdx#bomvalidatingcontext) | Yes | A context for passing information between states thoughout the BOM validation process. |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `VerifyingSku` | [BomValidatingContext](schema-nico-schemas.mdx#bomvalidatingcontext) | Yes | A context for passing information between states thoughout the BOM validation process. |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `SkuVerificationFailed` | [BomValidatingContext](schema-nico-schemas.mdx#bomvalidatingcontext) | Yes | A context for passing information between states thoughout the BOM validation process. |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `WaitingForSkuAssignment` | [BomValidatingContext](schema-nico-schemas.mdx#bomvalidatingcontext) | Yes | A context for passing information between states thoughout the BOM validation process. |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `SkuMissing` | [BomValidatingContext](schema-nico-schemas.mdx#bomvalidatingcontext) | Yes | A context for passing information between states thoughout the BOM validation process. |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `secure_erase_boss_context` | [SecureEraseBossContext](schema-nico-schemas.mdx#secureerasebosscontext) | Yes |  |
| `secure_erase_boss_context.boss_controller_id` | string | Yes |  |
| `secure_erase_boss_context.iteration` | integer or null | No |  |
| `secure_erase_boss_context.secure_erase_boss_state` | [SecureEraseBossState](schema-nico-schemas.mdx#secureerasebossstate) | Yes |  |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `create_boss_volume_context` | [CreateBossVolumeContext](schema-nico-schemas.mdx#createbossvolumecontext) | Yes |  |
...
| `create_boss_volume_context.create_boss_volume_state` | [CreateBossVolumeState](schema-nico-schemas.mdx#createbossvolumestate) | Yes |  |
...
| `create_boss_volume_state` | [CreateBossVolumeState](schema-nico-schemas.mdx#createbossvolumestate) | Yes |  |
...
| `enable_secure_boot_state` | [SetSecureBootState](schema-nico-schemas.mdx#setsecurebootstate) | Yes |  |
...
| `substate` | [InstallDpuOsState](schema-nico-schemas.mdx#installdpuosstate) | Yes |  |
...
| `substate` | [PerformPowerOperation](schema-nico-schemas.mdx#performpoweroperation) | Yes |  |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `cause` | [FailureCause](schema-nico-schemas.mdx#failurecause) | Yes |  |
| `failed_at` | string (date-time) | Yes |  |
| `source` | [FailureSource](schema-nico-schemas.mdx#failuresource) | Yes |  |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `statemachinearea` | [StateMachineArea](schema-nico-schemas.mdx#statemachinearea) | Yes | Values: `default`, `hostinit`, `mainflow`, `assignedinstance` |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `set_boot_order_info` | [SetBootOrderInfo](schema-nico-schemas.mdx#setbootorderinfo) | Yes |  |
| `set_boot_order_info.set_boot_order_jid` | string or null | No |  |
| `set_boot_order_info.set_boot_order_state` | [SetBootOrderState](schema-nico-schemas.mdx#setbootorderstate) | Yes |  |
...
| `initialreset.phase` | [InitialResetPhase](schema-nico-schemas.mdx#initialresetphase) | Yes | Values: `start`, `bmcwasreset`, `waithostboot` |
...
| `waitingforupload.firmware_type` | [FirmwareComponentType](schema-nico-schemas.mdx#firmwarecomponenttype) | Yes | Values: `bmc`, `cec`, `uefi`, `nic`, `cpldmb`, `cpldpdb`, `hgxbmc`, `combinedbmcuefi`, ... (10 total) |
...
| `waitingforfirmwareupgrade.firmware_type` | [FirmwareComponentType](schema-nico-schemas.mdx#firmwarecomponenttype) | Yes | Values: `bmc`, `cec`, `uefi`, `nic`, `cpldmb`, `cpldpdb`, `hgxbmc`, `combinedbmcuefi`, ... (10 total) |
...
| `resetfornewfirmware.firmware_type` | [FirmwareComponentType](schema-nico-schemas.mdx#firmwarecomponenttype) | Yes | Values: `bmc`, `cec`, `uefi`, `nic`, `cpldmb`, `cpldpdb`, `hgxbmc`, `combinedbmcuefi`, ... (10 total) |
...
| `newfirmwarereportedwait.firmware_type` | [FirmwareComponentType](schema-nico-schemas.mdx#firmwarecomponenttype) | Yes | Values: `bmc`, `cec`, `uefi`, `nic`, `cpldmb`, `cpldpdb`, `hgxbmc`, `combinedbmcuefi`, ... (10 total) |
...
| `failedfirmwareupgrade.firmware_type` | [FirmwareComponentType](schema-nico-schemas.mdx#firmwarecomponenttype) | Yes | Values: `bmc`, `cec`, `uefi`, `nic`, `cpldmb`, `cpldpdb`, `hgxbmc`, `combinedbmcuefi`, ... (10 total) |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `platform_config_state` | [HostPlatformConfigurationState](schema-nico-schemas.mdx#hostplatformconfigurationstate) | Yes |  |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `network_config_update_state` | [NetworkConfigUpdateState](schema-nico-schemas.mdx#networkconfigupdatestate) | Yes | Tenant has requested network config update for the existing instance. At this point, instance config, instance network config version are already increased. Values: `waitingfornetworksegmenttoberea... |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `mode` | [LockdownMode](schema-nico-schemas.mdx#lockdownmode) | Yes | Whether lockdown should be enabled or disabled in an operation Values: `enable`, `disable` |
| `state` | [LockdownState](schema-nico-schemas.mdx#lockdownstate) | Yes | Values: `setlockdown`, `timewaitfordpudown`, `waitfordpuup`, `pollinglockdownstatus` |
...
| `uefi_setup_info` | [UefiSetupInfo](schema-nico-schemas.mdx#uefisetupinfo) | Yes |  |
| `uefi_setup_info.uefi_password_jid` | string or null | No |  |
| `uefi_setup_info.uefi_setup_state` | [UefiSetupState](schema-nico-schemas.mdx#uefisetupstate) | Yes | Substates of enabling/disabling lockdown |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `lockdown_info` | [LockdownInfo](schema-nico-schemas.mdx#lockdowninfo) | Yes |  |
| `lockdown_info.mode` | [LockdownMode](schema-nico-schemas.mdx#lockdownmode) | Yes | Whether lockdown should be enabled or disabled in an operation Values: `enable`, `disable` |
| `lockdown_info.state` | [LockdownState](schema-nico-schemas.mdx#lockdownstate) | Yes | Values: `setlockdown`, `timewaitfordpudown`, `waitfordpuup`, `pollinglockdownstatus` |
...
| `bmcfirmwareupgrade.substate` | [BmcFirmwareUpgradeSubstate](schema-nico-schemas.mdx#bmcfirmwareupgradesubstate) | Yes |  |
...
| `installdpuos.substate` | [InstallDpuOsState](schema-nico-schemas.mdx#installdpuosstate) | Yes |  |
...
| `boss_controller_id` | string | Yes |  |
| `iteration` | integer or null | No |  |
| `secure_erase_boss_state` | [SecureEraseBossState](schema-nico-schemas.mdx#secureerasebossstate) | Yes |  |
...
| `set_boot_order_state` | [SetBootOrderState](schema-nico-schemas.mdx#setbootorderstate) | Yes |  |
...
| `uefi_setup_state` | [UefiSetupState](schema-nico-schemas.mdx#uefisetupstate) | Yes | Substates of enabling/disabling lockdown |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `machine_validation` | [MachineValidatingState](schema-nico-schemas.mdx#machinevalidatingstate) | Yes |  |
