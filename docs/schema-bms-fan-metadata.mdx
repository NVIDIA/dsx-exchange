...
Subscribe to BMS-published metadata for Fan points.
...
```text
BMS/v1/PUB/Metadata/Fan/{pointType}/{tagPath}
```
...
|-----------|-------------|
| `pointType` | Fan point type. Values: `FanSpeed`, `Available`, `GenericPoint` |
| `tagPath` | Vendor-defined hierarchical tag path. |

## Message: Fan FanSpeed Metadata
...
## Message: Fan Available Metadata
