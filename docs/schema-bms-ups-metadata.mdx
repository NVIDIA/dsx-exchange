...
Subscribe to BMS-published metadata for UPS points.
...
```text
BMS/v1/PUB/Metadata/UPS/{pointType}/{tagPath}
```
...
|-----------|-------------|
| `pointType` | UPS point type. Values: `Status`, `Available`, `GenericPoint` |
| `tagPath` | Vendor-defined hierarchical tag path. |

## Message: UPS Status Metadata
...
## Message: UPS Available Metadata
