...
Subscribe to real-time BMS-published values for Sensor points.
...
```text
BMS/v1/PUB/Value/Sensor/{pointType}/{tagPath}
```
...
|-----------|-------------|
| `pointType` | BMS-published Sensor point type. Values: `LiquidTemperature`, `LiquidDifferentialPressure`, `LiquidFlow`, `LiquidPressure`, `AirTemperature`, `AirDifferentialPressure` ... (13 total) |
