...
Subscribe to real-time BMS-published values for AHU points.
...
```
BMS/v1/PUB/Value/AHU/{pointType}/{tagPath}
```
...
|-----------|-------------|
| `pointType` | BMS-published AHU point type. Values: `LiquidTemperature`, `LiquidDifferentialPressure`, `LiquidFlow`, `LiquidPressure`, `Status`, `Available` ... (17 total) |
