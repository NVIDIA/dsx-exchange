...
Subscribe to real-time BMS-published values for CDU points.
...
```text
BMS/v1/PUB/Value/CDU/{pointType}/{tagPath}
```
...
|-----------|-------------|
| `pointType` | BMS-published CDU point type. Values: `LiquidTemperature`, `LiquidDifferentialPressure`, `LiquidFlow`, `LiquidPressure`, `Status`, `Available` ... (17 total) |
