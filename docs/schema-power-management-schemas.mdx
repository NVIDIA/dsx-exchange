...
| `load_constraint` | [LoadConstraint](schema-power-management-schemas.mdx#loadconstraint) | Yes | Power limit constraint. |
...
| `interval` | [Interval](schema-power-management-schemas.mdx#interval) | Yes | Time window for load target scheduling. |
...
| `strategy` | [Strategy](schema-power-management-schemas.mdx#strategy) | Yes | Load shedding strategy configuration. |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `metadata` | [FeedMetadata](schema-power-management-schemas.mdx#feedmetadata) | Yes | Static feed configuration. Values don't change during a curtailment event. |
...
| `breach` | [BreachDetails](schema-power-management-schemas.mdx#breachdetails) | Yes | Breach identification and timing. |
...
| `target` | [BreachTarget](schema-power-management-schemas.mdx#breachtarget) | Yes | The load target being breached. |
| `target.correlation_id` | string (uuid) | Yes | The correlationid from the grid.loadtarget.set.v1 that established this target. |
| `target.load_constraint` | [LoadConstraint](schema-power-management-schemas.mdx#loadconstraint) | Yes | Power limit constraint. |
