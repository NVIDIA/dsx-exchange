...
Subscribe to real-time BMS-published values for Valve points.
...
```
BMS/v1/PUB/Value/Valve/{pointType}/{tagPath}
```
...
|-----------|-------------|
| `pointType` | BMS-published Valve point type. Values: `ValvePosition`, `Available`, `GenericPoint` |
