...
Subscribe to BMS-published metadata for Chiller points.
...
```text
BMS/v1/PUB/Metadata/Chiller/{pointType}/{tagPath}
```
...
|-----------|-------------|
| `pointType` | Chiller point type. Values: `LiquidTemperature`, `LiquidDifferentialPressure`, `LiquidFlow`, `LiquidPressure`, `Status`, `Available` ... (17 total) |
| `tagPath` | Vendor-defined hierarchical tag path. |

## Message: Chiller LiquidTemperature Metadata
...
## Message: Chiller LiquidDifferentialPressure Metadata
...
## Message: Chiller LiquidFlow Metadata
...
## Message: Chiller LiquidPressure Metadata
...
## Message: Chiller Status Metadata
...
## Message: Chiller Available Metadata
...
## Message: Chiller ValvePosition Metadata
...
## Message: Chiller PumpSpeed Metadata
...
## Message: Chiller FanSpeed Metadata
...
## Message: Chiller DamperPosition Metadata
...
## Message: Chiller AirTemperature Metadata
...
## Message: Chiller AirDifferentialPressure Metadata
...
## Message: Chiller AirRelativeHumidity Metadata
...
## Message: Chiller AirFlow Metadata
...
## Message: Chiller AirPressure Metadata
...
## Message: Chiller LeakDetect Metadata
