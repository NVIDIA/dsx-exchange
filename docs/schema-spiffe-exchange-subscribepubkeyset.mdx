# Subscribe Pub Keyset

Subscribe to public key updates for a tenant and kid. Each message carries one JWK. Consumers use the key to verify signatures or encrypt.
