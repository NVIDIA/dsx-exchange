...
```text
BMS/v1/PUB/Metadata/Tank/{pointType}/{tagPath}
```
...
|-----------|-------------|
| `pointType` | Tank point type. Values: `LiquidTemperature`, `LiquidDifferentialPressure`, `LiquidFlow`, `LiquidPressure`, `Status`, `Available` ... (17 total) |
