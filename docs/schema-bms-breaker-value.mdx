...
Subscribe to real-time BMS-published values for Breaker points.
...
```
BMS/v1/PUB/Value/Breaker/{pointType}/{tagPath}
```
...
|-----------|-------------|
| `pointType` | BMS-published Breaker point type. Values: `Status`, `Available`, `GenericPoint` |
