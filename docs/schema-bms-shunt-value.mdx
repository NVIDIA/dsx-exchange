...
Subscribe to real-time BMS-published values for Shunt points.
...
```text
BMS/v1/PUB/Value/Shunt/{pointType}/{tagPath}
```
...
|-----------|-------------|
| `pointType` | BMS-published Shunt point type. Values: `Status`, `Available`, `GenericPoint` |
