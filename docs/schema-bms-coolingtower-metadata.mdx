...
Subscribe to BMS-published metadata for CoolingTower points.
...
```text
BMS/v1/PUB/Metadata/CoolingTower/{pointType}/{tagPath}
```
...
|-----------|-------------|
| `pointType` | CoolingTower point type. Values: `LiquidTemperature`, `LiquidDifferentialPressure`, `LiquidFlow`, `LiquidPressure`, `Status`, `Available` ... (17 total) |
| `tagPath` | Vendor-defined hierarchical tag path. |

## Message: CoolingTower LiquidTemperature Metadata
...
## Message: CoolingTower LiquidDifferentialPressure Metadata
...
## Message: CoolingTower LiquidFlow Metadata
...
## Message: CoolingTower LiquidPressure Metadata
...
## Message: CoolingTower Status Metadata
...
## Message: CoolingTower Available Metadata
...
## Message: CoolingTower ValvePosition Metadata
...
## Message: CoolingTower PumpSpeed Metadata
...
## Message: CoolingTower FanSpeed Metadata
...
## Message: CoolingTower DamperPosition Metadata
...
## Message: CoolingTower AirTemperature Metadata
...
## Message: CoolingTower AirDifferentialPressure Metadata
...
## Message: CoolingTower AirRelativeHumidity Metadata
...
## Message: CoolingTower AirFlow Metadata
...
## Message: CoolingTower AirPressure Metadata
...
## Message: CoolingTower LeakDetect Metadata
