...
Subscribe to BMS-published metadata for CDU points.
...
```text
BMS/v1/PUB/Metadata/CDU/{pointType}/{tagPath}
```
...
|-----------|-------------|
| `pointType` | CDU point type. Values: `LiquidTemperature`, `LiquidDifferentialPressure`, `LiquidFlow`, `LiquidPressure`, `Status`, `Available` ... (18 total) |
| `tagPath` | Vendor-defined hierarchical tag path. |

## Message: CDU LiquidTemperature Metadata
...
## Message: CDU LiquidDifferentialPressure Metadata
...
## Message: CDU LiquidFlow Metadata
...
## Message: CDU LiquidPressure Metadata
...
## Message: CDU Available Metadata
...
## Message: CDU ValvePosition Metadata
...
## Message: CDU PumpSpeed Metadata
...
## Message: CDU DamperPosition Metadata
...
## Message: CDU AirTemperature Metadata
...
## Message: CDU AirDifferentialPressure Metadata
...
## Message: CDU AirRelativeHumidity Metadata
...
## Message: CDU AirPressure Metadata
...
## Message: CDU LeakDetect Metadata
...
## Message: CDU LiquidTemperatureSpRequest Metadata
