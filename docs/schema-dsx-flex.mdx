...
<Accordion title="View / copy the raw AsyncAPI YAML">
...
channels:
  ...
  powerStateStatusChannel:
    address: grid/v1/dsx-flex-agent/{identifier}/powerstate/status
    parameters:
      identifier:
        $ref: '#/components/parameters/identifier'
    messages:
    ...
    description: |
      DSX Flex Agent publishes full snapshots of current power state
  ...
  powerBreachAlertChannel:
    address: grid/v1/dsx-flex-agent/{identifier}/powerbreach
    parameters:
      identifier:
        $ref: '#/components/parameters/identifier'
    messages:
    ...
    description: |
      DSX Flex Agent publishes breach alerts when measured power exceeds
...
operations:
  publishLoadTargetSet:
    ...
    summary: ISV → DSX Flex Agent (set load target command)
    messages:
  ...
  subscribeLoadTargetSet:
    ...
    channel:
      $ref: '#/channels/loadTargetSetChannel'
    summary: DSX Flex Agent subscribes to load target commands
    messages:
      - $ref: '#/channels/loadTargetSetChannel/messages/loadTargetSet'
  ...
  publishPowerStateStatus:
    ...
    summary: DSX Flex Agent → ISVs (power state snapshot)
    messages:
  ...
  publishPowerBreachAlert:
    ...
    summary: DSX Flex Agent → Infra Agent + ISVs (breach alert)
    messages:
  ...
  publishPowerBreachEnforcement:
    ...
    summary: Infra Agent → DSX Flex Agent + ISVs (enforcement outcome)
    messages:
  ...
  subscribePowerBreachEnforcement:
    ...
    channel:
      $ref: '#/channels/powerBreachEnforcementChannel'
    summary: DSX Flex Agent and ISVs subscribe to enforcement outcomes
    messages:
      - $ref: '#/channels/powerBreachEnforcementChannel/messages/powerBreachEnforcement'
...
components:
    ...
    Strategy:
      ...
      properties:
        best_effort:
          ...
          default: false
          description: |
            If true, DSX Flex Agent sheds load non-disruptively by adjusting DPM-enabled jobs.
            If the constraint cannot be satisfied, DSX Flex Agent sheds as much as possible and
      ...
      properties:
        ...
        correlationid:
          ...
          description: |
            ...
            DSX Flex Agent in status events for correlation.
        traceparent:
          type: string
  ...
  messages:
    ...
    PowerStateStatusMessage:
      ...
      summary: DSX Flex Agent publishes full power state snapshot.
      contentType: application/cloudevents+json
      payload:
    ...
    PowerBreachAlertMessage:
      ...
      summary: DSX Flex Agent publishes breach alert with shed hints.
      contentType: application/cloudevents+json
      payload:
