...
Subscribe to real-time BMS-published values for Pump points.
...
```
BMS/v1/PUB/Value/Pump/{pointType}/{tagPath}
```
...
|-----------|-------------|
| `pointType` | BMS-published Pump point type. Values: `PumpSpeed`, `Available`, `GenericPoint` |
