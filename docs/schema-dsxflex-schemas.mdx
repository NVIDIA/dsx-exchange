...
| `load_constraint` | [LoadConstraint](schema-dsxflex-schemas.mdx#loadconstraint) | Yes | Power limit constraint. |
...
| `interval` | [Interval](schema-dsxflex-schemas.mdx#interval) | Yes | Time window for load target scheduling. |
...
| `strategy` | [Strategy](schema-dsxflex-schemas.mdx#strategy) | Yes | Load shedding strategy configuration. |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `metadata` | [FeedMetadata](schema-dsxflex-schemas.mdx#feedmetadata) | Yes | Static feed configuration. Values don't change during a curtailment event. |
...
| `targets` | array&lt;[FeedTarget](schema-dsxflex-schemas.mdx#feedtarget)&gt; | Yes | All load targets for this feed — active and scheduled. Empty array if no targets exist. |
...
| `feeds` | map&lt;string, [FeedState](schema-dsxflex-schemas.mdx#feedstate)&gt; | Yes | Map of feed_tag to power state. |
...
| `breach` | [BreachDetails](schema-dsxflex-schemas.mdx#breachdetails) | Yes | Breach identification and timing. |
...
| `target` | [BreachTarget](schema-dsxflex-schemas.mdx#breachtarget) | Yes | The load target being breached. |
| `target.correlation_id` | string (uuid) | Yes | The correlationid from the grid.loadtarget.set.v1 that established this target. |
| `target.load_constraint` | [LoadConstraint](schema-dsxflex-schemas.mdx#loadconstraint) | Yes | Power limit constraint. |
...
| `shed_hints` | array&lt;[ShedHint](schema-dsxflex-schemas.mdx#shedhint)&gt; | No | Ordered list of load shedding recommendations. Present when status is active or escalated. Absent when resolved. |
...
| `results` | array&lt;[EnforcementResult](schema-dsxflex-schemas.mdx#enforcementresult)&gt; | Yes | Per-resource enforcement outcome. |
...
| `traceparent` | string | Yes | REQUIRED per W3C Trace Context and CloudEvents Distributed Tracing Extension. Format: version-traceid-parentid-flags. |
| `tracestate` | string | No | OPTIONAL per W3C Trace Context. Carries vendor-specific contextual information across tracing systems. |
| `data` | [JwsCompactSerialization](schema-dsxflex-schemas.mdx#jwscompactserialization) or [PowerStateStatusData](schema-dsxflex-schemas.mdx#powerstatestatusdata) | Yes | WIRE FORMAT: JWS compact serialization string (type: string). PLAINTEXT CONTENT: After JWS verification, the payload conforms to PowerStateStatusData schema (type: object). |
...
| `traceparent` | string | Yes | REQUIRED per W3C Trace Context and CloudEvents Distributed Tracing Extension. Format: version-traceid-parentid-flags. |
| `tracestate` | string | No | OPTIONAL per W3C Trace Context. Carries vendor-specific contextual information across tracing systems. |
| `data` | [JwsCompactSerialization](schema-dsxflex-schemas.mdx#jwscompactserialization) or [PowerBreachAlertData](schema-dsxflex-schemas.mdx#powerbreachalertdata) | Yes | WIRE FORMAT: JWS compact serialization string (type: string). PLAINTEXT CONTENT: After JWS verification, the payload conforms to PowerBreachAlertData schema (type: object). |
...
| `traceparent` | string | Yes | REQUIRED per W3C Trace Context and CloudEvents Distributed Tracing Extension. Format: version-traceid-parentid-flags. |
| `tracestate` | string | No | OPTIONAL per W3C Trace Context. Carries vendor-specific contextual information across tracing systems. |
| `data` | [JwsCompactSerialization](schema-dsxflex-schemas.mdx#jwscompactserialization) or [PowerBreachEnforcementData](schema-dsxflex-schemas.mdx#powerbreachenforcementdata) | Yes | WIRE FORMAT: JWS compact serialization string (type: string). PLAINTEXT CONTENT: After JWS verification, the payload conforms to PowerBreachEnforcementData schema (type: object). |
