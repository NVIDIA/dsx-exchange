...
Subscribe to real-time BMS-published values for HX points.
...
```
BMS/v1/PUB/Value/HX/{pointType}/{tagPath}
```
...
|-----------|-------------|
| `pointType` | BMS-published HX point type. Values: `LiquidTemperature`, `LiquidDifferentialPressure`, `LiquidFlow`, `LiquidPressure`, `Status`, `Available` ... (17 total) |
