...
Subscribe to BMS-published metadata for Valve points.
...
```text
BMS/v1/PUB/Metadata/Valve/{pointType}/{tagPath}
```
...
|-----------|-------------|
| `pointType` | Valve point type. Values: `ValvePosition`, `Available`, `GenericPoint` |
| `tagPath` | Vendor-defined hierarchical tag path. |

## Message: Valve ValvePosition Metadata
...
## Message: Valve Available Metadata
