...
Subscribe to real-time BMS-published values for Chiller points.
...
```text
BMS/v1/PUB/Value/Chiller/{pointType}/{tagPath}
```
...
|-----------|-------------|
| `pointType` | BMS-published Chiller point type. Values: `LiquidTemperature`, `LiquidDifferentialPressure`, `LiquidFlow`, `LiquidPressure`, `Status`, `Available` ... (17 total) |
