...
Subscribe to real-time BMS-published values for ATS points.
...
```text
BMS/v1/PUB/Value/ATS/{pointType}/{tagPath}
```
...
|-----------|-------------|
| `pointType` | BMS-published ATS point type. Values: `Status`, `Available`, `GenericPoint` |
