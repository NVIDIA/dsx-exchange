...
Subscribe to real-time BMS-published values for CRAH points.
...
```text
BMS/v1/PUB/Value/CRAH/{pointType}/{tagPath}
```
...
|-----------|-------------|
| `pointType` | BMS-published CRAH point type. Values: `LiquidTemperature`, `LiquidDifferentialPressure`, `LiquidFlow`, `LiquidPressure`, `Status`, `Available` ... (17 total) |
