...
Subscribe to BMS-published metadata for AHU points.
...
```text
BMS/v1/PUB/Metadata/AHU/{pointType}/{tagPath}
```
...
|-----------|-------------|
| `pointType` | AHU point type. Values: `LiquidTemperature`, `LiquidDifferentialPressure`, `LiquidFlow`, `LiquidPressure`, `Status`, `Available` ... (17 total) |
| `tagPath` | Vendor-defined hierarchical tag path. |

## Message: AHU LiquidTemperature Metadata
...
## Message: AHU LiquidDifferentialPressure Metadata
...
## Message: AHU LiquidFlow Metadata
...
## Message: AHU LiquidPressure Metadata
...
## Message: AHU Available Metadata
...
## Message: AHU ValvePosition Metadata
...
## Message: AHU PumpSpeed Metadata
...
## Message: AHU DamperPosition Metadata
...
## Message: AHU AirTemperature Metadata
...
## Message: AHU AirDifferentialPressure Metadata
...
## Message: AHU AirRelativeHumidity Metadata
...
## Message: AHU AirPressure Metadata
...
## Message: AHU LeakDetect Metadata
