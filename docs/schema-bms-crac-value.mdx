...
Subscribe to real-time BMS-published values for CRAC points.
...
```text
BMS/v1/PUB/Value/CRAC/{pointType}/{tagPath}
```
...
|-----------|-------------|
| `pointType` | BMS-published CRAC point type. Values: `LiquidTemperature`, `LiquidDifferentialPressure`, `LiquidFlow`, `LiquidPressure`, `Status`, `Available` ... (17 total) |
