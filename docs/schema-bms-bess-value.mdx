...
Subscribe to real-time BMS-published values for BESS points.
...
```text
BMS/v1/PUB/Value/BESS/{pointType}/{tagPath}
```
...
|-----------|-------------|
| `pointType` | BMS-published BESS point type. Values: `Status`, `Available`, `GenericPoint` |
